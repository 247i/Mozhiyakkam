<?php
// utf-8 (ChineseBig5) Nucleus Language File
//
// Author: Jacky Kit
...
define('_LIST_PLUG_SUBS_NEEDUPDATE','請使用「更新訂閱清單」按鈕來更新插件的訂閱清單。');
define('_LIST_PLUGS_DEP',			'插件要求：');
...
define('_COMMENTS_BLOG',			'此Blog中的全部評論');
define('_NOCOMMENTS_BLOG',			'此Blog中的文章未收到評論');
define('_BLOGLIST_COMMENTS',		'評論');
define('_BLOGLIST_TT_COMMENTS',		'此Blog中的文章收到的所有評論的清單');
...
define('_ERROR_BADTICKET',			'非法或過期票。');

// plugin dependency
define('_ERROR_INSREQPLUGIN',		'插件安裝失敗，需要安裝');
define('_ERROR_DELREQPLUGIN',		'插件刪除失敗，依賴插件有');

// cookie prefix
define('_SETTINGS_COOKIEPREFIX',	'Cookie前綴');

// account activation
define('_ERROR_NOLOGON_NOACTIVATE',	'不能發送啟用鏈接。您目前還不能登錄。');
define('_ERROR_ACTIVATE',			'啟用碼不存在，或不正確，或者已經過期。');
define('_ACTIONLOG_ACTIVATIONLINK', '啟用所用的鏈接已經發出');
define('_MSG_ACTIVATION_SENT',		'啟用所用的鏈接已經發往您的信箱。');

// activation link emails
define('_ACTIVATE_REGISTER_MAIL',	"您好，<%memberName%>,\n\n您需要啟用您在 <%siteName%> (<%siteUrl%>)的賬號。\n為此，您可以訪問以下網址：\n\n\t<%activationUrl%>\n\n此鏈接2日內有效，之後將不能使用。");
define('_ACTIVATE_REGISTER_MAILTITLE',	"啟用您的 '<%memberName%>' 賬號");
define('_ACTIVATE_REGISTER_TITLE',	'歡迎 <%memberName%>');
define('_ACTIVATE_REGISTER_TEXT',	'馬上就完成了。請為此賬號選擇一個密碼。');
define('_ACTIVATE_FORGOT_MAIL',		"您好，<%memberName%>,\n\n使用下面的鏈接，您可以為您在 <%siteName%> (<%siteUrl%>) 的賬號設定一個新的密碼。\n\n\t<%activationUrl%>\n\n此鏈接2日內有效，之後將不能使用。");
define('_ACTIVATE_FORGOT_MAILTITLE',"重新啟用您的 '<%memberName%>' 賬號");
define('_ACTIVATE_FORGOT_TITLE',	'歡迎 <%memberName%>');
define('_ACTIVATE_FORGOT_TEXT',		'您可以為該賬號選擇一個新密碼：');
define('_ACTIVATE_CHANGE_MAIL',		"您好，<%memberName%>，\n\n因為您的E-mail地址已經改變，所以您必須再次啟用您在 <%siteName%> (<%siteUrl%>) 的賬號。\n要重新啟用，您可以訪問以下網址：\n\n\t<%activationUrl%>\n\n此網址2日內有效，之後將不能使用。");
define('_ACTIVATE_CHANGE_MAILTITLE',"Re-activate your '<%memberName%>' account");
define('_ACTIVATE_CHANGE_TITLE',	'歡迎 <%memberName%>');
define('_ACTIVATE_CHANGE_TEXT',		'您的地址變更已經確認。謝謝！');
define('_ACTIVATE_SUCCESS_TITLE',	'啟用成功');
define('_ACTIVATE_SUCCESS_TEXT',	'您的賬號已成功啟用。');
define('_MEMBERS_SETPWD',			'設置密碼');
define('_MEMBERS_SETPWD_BTN',		'設置密碼');
define('_QMENU_ACTIVATE',			'賬號啟用');
define('_QMENU_ACTIVATE_TEXT',		'<p>在啟用賬號後，您即可<a href="index.php?action=showlogin">登錄</a>並使用本站。</p>');

define('_PLUGS_BTN_UPDATE',			'更新訂閱名單');

// global settings
define('_SETTINGS_JSTOOLBAR',		'Javascript工具欄風格');
define('_SETTINGS_JSTOOLBAR_FULL',	'完整工具欄(IE)');
define('_SETTINGS_JSTOOLBAR_SIMPLE','簡單工具欄(非IE)');
define('_SETTINGS_JSTOOLBAR_NONE',	'取消工具條');
define('_SETTINGS_URLMODE_HELP',	'(提示: <a href="documentation/tips.html#searchengines-fancyurls">如何啟用優雅URL</a>)');

// extra plugin settings part when editing categories/members/blogs/...
define('_PLUGINS_EXTRA',			'額外插件設置');

// itemlist info column keys
define('_LIST_ITEM_BLOG',			'Blog：');
define('_LIST_ITEM_CAT',			'目錄：');
define('_LIST_ITEM_AUTHOR',			'作者：');
define('_LIST_ITEM_DATE',			'日期：');
define('_LIST_ITEM_TIME',			'時間：');

// indication of registered members in comments list
define('_LIST_COMMENTS_MEMBER',	'(成員)');

// batch operations
define('_BATCH_WITH_SEL',			'對所有選中條目：');
define('_BATCH_EXEC',				'執行');

// quickmenu
define('_QMENU_HOME',				'管理區主頁');
define('_QMENU_ADD',				'添加新文章');
define('_QMENU_ADD_SELECT',			'-- 選擇 --');
define('_QMENU_USER_SETTINGS',		'設置');
define('_QMENU_USER_ITEMS',			'文章');
define('_QMENU_USER_COMMENTS',		'評論');
define('_QMENU_MANAGE',				'管理');
define('_QMENU_MANAGE_LOG',			'活動記錄');
define('_QMENU_MANAGE_SETTINGS',	'全局設置');
define('_QMENU_MANAGE_MEMBERS',		'成員');
define('_QMENU_MANAGE_NEWBLOG',		'新建Blog');
define('_QMENU_MANAGE_BACKUPS',		'備份');
define('_QMENU_MANAGE_PLUGINS',		'插件');
define('_QMENU_LAYOUT',				'佈局');
define('_QMENU_LAYOUT_SKINS',		'面板');
define('_QMENU_LAYOUT_TEMPL',		'模板');
define('_QMENU_LAYOUT_IEXPORT',		'導入/導出');
define('_QMENU_PLUGINS',			'插件');

// quickmenu on logon screen
define('_QMENU_INTRO',				'介紹');
define('_QMENU_INTRO_TEXT',			'<p>這裡是Nucleus CMS的登錄界面，Nucleus CMS即本站所用之內容管理系統。</p><p>如果您擁有本站賬號，您即可登錄並發表新文章。</p>');

// helppages for plugins
define('_ERROR_PLUGNOHELPFILE',		'找不到此插件的幫助頁面');
define('_PLUGS_HELP_TITLE',			'插件幫助頁面');
define('_LIST_PLUGS_HELP',		'幫助');
...
define('_SETTINGS_EXTAUTH',			'允許外部認證');
define('_WARNING_EXTAUTH',			'警告：應該僅在需要時允許.');

// member profile
define('_MEMBERS_BYPASS',			'使用外部認證');

// 'always include in search' blog setting (yes/no) [in v2.5beta、the 'always' part wasn't clear]
define('_EBLOG_SEARCH',				'搜索時 <em>總是</em> 包括');

// END changed/added after v2.5beta END

// START introduced after v2.0 START

// media library
define('_MEDIA_VIEW',				'查看');
define('_MEDIA_VIEW_TT',				'查看檔案（在新窗口中打開）');
define('_MEDIA_FILTER_APPLY',			'應用過濾器');
define('_MEDIA_FILTER_LABEL',			'過濾器：');
define('_MEDIA_UPLOAD_TO',			'上載到…');
define('_MEDIA_UPLOAD_NEW',			'上載新檔案…');
...
define('_ERROR_MOVEDEFCATEGORY',	'不能移動預設類別');
define('_ERROR_MOVETOSELF',			'無法移動類別（目標Blog與源Blog相同）');
...
define('_BATCH_MEMBERS',			'成員批處理');
define('_BATCH_TEAM',				'團隊成員批處理');
...
define('_BATCH_ONMEMBER',			'在成員');
define('_BATCH_ONTEAM',				'在團隊成員');
...
define('_BATCH_CAT_MOVE',			'移動到其他Blog');
...
// backlinks
define('_BACK_TO_BLOGSETTINGS',		'返回Blog設置');
...
define('_SKINIE_LOCAL',				'從本地檔案導入：');
define('_SKINIE_NOCANDIDATES',		'在面板路徑中沒有找到任何候選檔案');
...
define('_SKINIE_CONFIRM_OVERWRITE',	'覆蓋已經存在的面板檔案（察看名稱衝突）');
define('_SKINIE_CONFIRM_IMPORT',		'是的，我想導入該檔案');
define('_SKINIE_CONFIRM_TITLE',		'取消導入面板與模版');
define('_SKINIE_INFO_SKINS',			'檔案中的面板：');
...
define('_BACKUP_INTRO',				'點擊下面的按鈕建立一份新聞系統的備份資料庫.按照提示保存一個備份檔案，將它保存在安全的地方。');
define('_BACKUP_ZIP_YES',			'嘗試使用壓縮');
define('_BACKUP_ZIP_NO',				'不使用壓縮');
define('_BACKUP_BTN',				'建立備份');
define('_BACKUP_NOTE',				'<b>注意：</b> 只有資料庫的內容在備份中保存，不包括<b>config.php</b>.');
define('_RESTORE_TITLE',				'恢復');
define('_RESTORE_NOTE',				'<b>注意：</b> 恢復一個資料庫 <b>清除</b> 當前系統資料庫中的所有資料！當您真的確定之後才可以執行此操作!	<br />	<b>注意：</b>確定生成備份檔案的的文章系統的版本與您現在所使用的版本相同！否則可能無法正常工作');
define('_RESTORE_INTRO',				'選擇下面的備份檔案(它將會被調入到服務器) 點擊「恢復」按鈕開始.');
define('_RESTORE_IMSURE',			'是的，我確定執行此操作！');
define('_RESTORE_BTN',				'從檔案中恢復');
define('_RESTORE_WARNING',			'(確定您正在恢復一個正確的備份，在您開始之前您可以建立一個當前備份)');
define('_ERROR_BACKUP_NOTSURE',		'您需要檢查一下我確定');
...
// plugins
define('_CONFIRMTXT_PLUGIN',			'確定要刪除已經命名的插件嗎？');
...
define('_PLUGS_TEXT_UPDATE',			'Nucleus為插件保存了事件描述的緩存。當您升級替換插件後，應該運行升級程式以保證事件描述得到更新');
define('_PLUGS_TITLE_NEW',			'安裝新插件');
define('_PLUGS_ADD_TEXT',			'下面是您插件目錄中所有檔案的列表，那可能是未安裝的的插件。在安裝之前請<strong>確認</strong>那是一個有效的插件檔案。');
...
define('_ADD_LEFT_TT',				'添加左邊盒子(div塊)');
define('_ADD_RIGHT_TT',				'添加右邊盒子(div塊)');
...
define('_SETTINGS_MAXUPLOADSIZE',	'上傳檔案最大容量（bytes）');
define('_SETTINGS_NONMEMBERMSGS',	'允許非成員發送消息');
define('_SETTINGS_PROTECTMEMNAMES',	'保護成員名字');

// overview screen
define('_OVERVIEW_PLUGINS',			'管理插件…');

// actionlog
define('_ACTIONLOG_NEWMEMBER',		'新成員註冊：');

// membermail (when not logged in)
define('_MEMBERMAIL_MAIL',			'我的郵件地址：');

// file upload
define('_ERROR_DISALLOWEDUPLOAD2',	'您在包含此目標成員的所有Blog上都沒有管理權限，所以，您不能將檔案上傳到該成員的媒體目錄');
...
// commentform
define('_COMMENTFORM_YOUARE',		'我是');
define('_COMMENTFORM_SUBMIT',		'添加評論');
define('_COMMENTFORM_COMMENT',		'我的評論');
...
define('_ADD_PLACE_ON',				'積累');
define('_ADD_ADDDRAFT',				'保存為草稿');
define('_ADD_NOPASTDATES',			'（過去的日期和時間是無效的，系統將使用當前時間）');
define('_ADD_BOLD_TT',				'粗體');
define('_ADD_ITALIC_TT',				'斜體');
define('_ADD_HREF_TT',				'建立超級鏈接');
define('_ADD_MEDIA_TT',				'添加媒體檔案');
define('_ADD_PREVIEW_TT',			'顯示/隱藏 預覽');
define('_ADD_CUT_TT',				'剪切');
define('_ADD_COPY_TT',				'複製');
define('_ADD_PASTE_TT',				'粘貼');


// edit item form
define('_EDIT_ITEM',					'編輯文章');
define('_EDIT_SUBMIT',				'保存編輯');
define('_EDIT_ORIG_AUTHOR',			'原創作者');
define('_EDIT_BACKTODRAFTS',			'添加回草稿');
define('_EDIT_COMMENTSNOTE',		'（注意：關閉評論並不能刪除現有評論）');

// used on delete screens
define('_DELETE_CONFIRM',			'請確認刪除');
define('_DELETE_CONFIRM_BTN',		'確認刪除');
define('_CONFIRMTXT_ITEM',			'您將刪除以下文章：');
define('_CONFIRMTXT_COMMENT',		'您將刪除以下評論：');
define('_CONFIRMTXT_TEAM1',			'即將刪除');
define('_CONFIRMTXT_TEAM2',			'從Blog團隊列表中');
define('_CONFIRMTXT_BLOG',			'您將要刪除的Blog為：');
define('_WARNINGTXT_BLOGDEL',		'警告！刪除Blog將會刪除其上的的所有文章和評論。請確定是否真的要刪除Blog<br />同時，在移動Blog時不要終止系統。');
define('_CONFIRMTXT_MEMBER',		'您將會刪除下面成員檔案：');
define('_CONFIRMTXT_TEMPLATE',		'您將刪除已命名的模版');
define('_CONFIRMTXT_SKIN',			'您將刪除已命名的面板');
define('_CONFIRMTXT_BAN',			'您將刪除對這些IP的封鎖');
define('_CONFIRMTXT_CATEGORY',		'您將刪除類別');

// some status messages
define('_DELETED_ITEM',				'文章已刪除');
define('_DELETED_MEMBER',			'成員已刪除');
define('_DELETED_COMMENT',			'評論已刪除');
define('_DELETED_BLOG',				'Blog已刪除');
define('_DELETED_CATEGORY',			'類別已刪除');
define('_ITEM_MOVED',				'文章已移動');
define('_ITEM_ADDED',				'文章已添加');
define('_COMMENT_UPDATED',			'評論已更新');
define('_SKIN_UPDATED',				'面板資料已經保存');
define('_TEMPLATE_UPDATED',			'模版資料已經保存');
...
define('_ERROR_COMMENT_TOOLONG',	'您的評論太長(最長：2500字)');
define('_ERROR_COMMENTS_DISABLED',	'本文禁止評論.');
define('_ERROR_COMMENTS_NONPUBLIC',	'您必須以成員身份登錄才可以添加評論');
define('_ERROR_COMMENTS_MEMBERNICK','您想使用的這個名字已經被其他人使用，請另選一個。');
define('_ERROR_SKIN',				'面板錯誤');
define('_ERROR_ITEMCLOSED',			'這篇文章已經關閉，不能添加評論和投票');
define('_ERROR_NOSUCHITEM',			'沒有這篇文章');
define('_ERROR_NOSUCHBLOG',			'沒有這個Blog');
define('_ERROR_NOSUCHSKIN',			'沒有這個面板');
define('_ERROR_NOSUCHMEMBER',		'沒有這個成員');
define('_ERROR_NOTONTEAM',			'您不在該Blog的團隊列表上。');
define('_ERROR_BADDESTBLOG',		'預定版不存在');
define('_ERROR_NOTONDESTTEAM',		'不能移動文章,您不在這個Blog的成員列表上');
...
define('_ERROR_NICKNAMEINUSE',		'已經有一個成員使用那個暱稱');
define('_ERROR_PASSWORDMISMATCH',	'密碼必須匹配');
define('_ERROR_PASSWORDTOOSHORT',	'密碼最少6個字符');
define('_ERROR_PASSWORDMISSING',	'密碼不能為空');
define('_ERROR_REALNAMEMISSING',		'您必須輸入一個真實的名字');
define('_ERROR_ATLEASTONEADMIN',		'系統至少應該存在一個可以登錄到管理界面的超級用戶。');
define('_ERROR_ATLEASTONEBLOGADMIN','請確定至少有一個超級用戶。');
define('_ERROR_ALREADYONTEAM',		'團隊中已經存在這個成員');
define('_ERROR_BADSHORTBLOGNAME',	'Blog縮寫只允許包含a-z,0-9');
define('_ERROR_DUPSHORTBLOGNAME',	'其他Blog已經使用這個縮寫名稱');
define('_ERROR_UPDATEFILE',			'對升級檔案沒有寫入權限，請確定檔案權限設置正確（chmod 666）。同時注意路徑是基於管理目錄的相對路徑，所以您可能需要使用絕對路徑（如/your/path/to/nucleus/）。');
define('_ERROR_DELDEFBLOG',			'不能刪除預設Blog');
define('_ERROR_DELETEMEMBER',		'該成員無法刪除，他可能是文章或評論的作者');
define('_ERROR_BADTEMPLATENAME',	'無效的模版名（只允許a-z、0-9）');
define('_ERROR_DUPTEMPLATENAME',	'已存在一個這樣名字的模版');
define('_ERROR_BADSKINNAME',		'無效面板名（只允許a-z、0-9）');
define('_ERROR_DUPSKINNAME',		'已存在同名面板');
define('_ERROR_DEFAULTSKIN',			'系統必須有一個名為"default"的預設面板');
define('_ERROR_SKINDEFDELETE',		'這是預設面板，不能刪除：');
define('_ERROR_DISALLOWED',			'對不起，您沒有權力執行該動作');
define('_ERROR_DELETEBAN',			'刪除封鎖的時候發生錯誤（封鎖不存在）。');
define('_ERROR_ADDBAN',				'添加封鎖的時候發生錯誤，它可能沒有正確添加到您的所有Blog裡。');
define('_ERROR_BADACTION',			'需要的動作不存在');
define('_ERROR_MEMBERMAILDISABLED',	'成員到成員的郵件消息被禁止');
define('_ERROR_MEMBERCREATEDISABLED','建立成員賬號被禁止');
define('_ERROR_INCORRECTEMAIL',		'不正確的郵件地址');
define('_ERROR_VOTEDBEFORE',		'您已經為這個文章投過票了');
...
define('_ERROR_FILE_TOO_BIG',			'檔案太大！');
define('_ERROR_BADFILETYPE',			'對不起，不允許上傳這種格式的檔案');
define('_ERROR_BADREQUEST',			'無效的上傳請求');
define('_ERROR_DISALLOWEDUPLOAD',	'您不在任何Blog的團隊列表中，沒有上傳檔案的權力');
define('_ERROR_BADPERMISSIONS',		'檔案/目錄權限設置不正確');
define('_ERROR_UPLOADMOVEP',		'上傳檔案時發生錯誤');
define('_ERROR_UPLOADCOPY',			'拷貝檔案時發生錯誤');
define('_ERROR_UPLOADDUPLICATE',		'已經有一個同名檔案，上傳之前請先改名。');
define('_ERROR_LOGINDISALLOWED',		'對不起，您不能登錄管理區。但可以用其他用戶身份登錄');
define('_ERROR_DBCONNECT',			'無法連接到 MySQL 服務器');
define('_ERROR_DBSELECT',			'無法選擇文章系統的資料庫');
define('_ERROR_NOSUCHLANGUAGE',	'沒有這個語言檔案');
define('_ERROR_NOSUCHCATEGORY',		'沒有這個類別');
define('_ERROR_DELETELASTCATEGORY',	'至少一個類別');
define('_ERROR_DELETEDEFCATEGORY',	'不能刪除預設類別');
...
// media and upload
define('_MEDIA_UPLOADLINK',			'上傳一個新檔案');
define('_MEDIA_MODIFIED',			'修改');
define('_MEDIA_FILENAME',			'檔案名');
define('_MEDIA_DIMENSIONS',			'檔案大小');
define('_MEDIA_INLINE',				'本窗口');
define('_MEDIA_POPUP',				'新窗口');
define('_UPLOAD_TITLE',				'選擇檔案');
define('_UPLOAD_MSG',				'選擇您想上傳的檔案，然後點擊 \'Upload\' 按鈕。');
define('_UPLOAD_BUTTON',			'上傳');

// some status messages
define('_MSG_ACCOUNTCREATED',		'賬號已建立，密碼將會通過郵件通知您');
define('_MSG_PASSWORDSENT',		'密碼已通過郵件發出。');
define('_MSG_LOGINAGAIN',			'您需要重新登錄，因為您的信息已經改變。');
define('_MSG_SETTINGSCHANGED',		'設置改變');
define('_MSG_ADMINCHANGED',		'管理員改變');
define('_MSG_NEWBLOG',				'新的Blog已建立');
define('_MSG_ACTIONLOGCLEARED',		'清空動作日誌');

// actionlog in admin area
define('_ACTIONLOG_DISALLOWED',		'不允許的動作：');
define('_ACTIONLOG_PWDREMINDERSENT','新密碼送出為');
define('_ACTIONLOG_TITLE',			'動作記錄');
define('_ACTIONLOG_CLEAR_TITLE',		'清空動作日誌');
define('_ACTIONLOG_CLEAR_TEXT',		'現在就清空動作日誌');

// team management
define('_TEAM_TITLE',				'管理此Blog的團隊');
define('_TEAM_CURRENT',				'當前成員');
define('_TEAM_ADDNEW',				'向團隊中添加新成員');
define('_TEAM_CHOOSEMEMBER',		'選擇成員');
define('_TEAM_ADMIN',				'超級管理員權限？ ');
define('_TEAM_ADD',					'添加到團隊');
define('_TEAM_ADD_BTN',				'添加到團隊');

// blogsettings
define('_EBLOG_TITLE',				'編輯Blog設置');
define('_EBLOG_TEAM_TITLE',			'編輯團隊');
define('_EBLOG_TEAM_TEXT',			'點擊這裡編輯我的團隊…');
define('_EBLOG_SETTINGS_TITLE',		'Blog設置');
define('_EBLOG_NAME',				'Blog名');
define('_EBLOG_SHORTNAME',			'Blog名縮寫');
define('_EBLOG_SHORTNAME_EXTRA',	'<br />(只允許包含 a-z )');
define('_EBLOG_DESC',				'Blog描述');
define('_EBLOG_URL',				'URL');
define('_EBLOG_DEFSKIN',				'預設面板');
define('_EBLOG_DEFCAT',				'預設類別');
define('_EBLOG_LINEBREAKS',			'轉換行中斷');
define('_EBLOG_DISABLECOMMENTS',	'開啟評論');
define('_EBLOG_ANONYMOUS',			'允許非成員評論');
...
define('_EBLOG_NOTIFY_ITEM',			'新的Blog文章');
...
define('_EBLOG_BTIME',				'當前Blog時間為');
define('_EBLOG_CHANGE',				'改變設置');
define('_EBLOG_CHANGE_BTN',			'改變設置');
define('_EBLOG_ADMIN',				'Blog管理員');
define('_EBLOG_ADMIN_MSG',			'將被授予管理員權力');
define('_EBLOG_CREATE_TITLE',			'創建新Blog');
define('_EBLOG_CREATE_TEXT',			'填寫下面的表單創建一個新Blog。<br /><br /> <b>注意：</b> 列表中只有必要的選項，如果您想更改更多的選項，創建後再到相應的設置中去修改。');
define('_EBLOG_CREATE',				'創建！');
define('_EBLOG_CREATE_BTN',			'創建Blog');
...
define('_TEMPLATE_EDIT_MSG',			'並非所有的模版都是需要的,您不需要的那些可以留空.');
...
define('_TEMPLATE_MORELINK',			'指向擴展入口的鏈接');
define('_TEMPLATE_NEW',				'新文章標誌');
...
define('_TEMPLATE_CMEXTRA',			'成員擴展');
define('_TEMPLATE_COMMENTS_NONE',	'評論(如果沒有)');
define('_TEMPLATE_CNONE',			'沒有評論');
define('_TEMPLATE_COMMENTS_TOOMUCH','評論 (太多，無法線上顯示)');
...
define('_SKIN_AVAILABLE_TITLE',		'有效面板');
...
define('_SKIN_PARTS_MSG',		'並不是所有的面板都是必需的，不需要的可以留空。選擇下面需要編輯的面板類型');
define('_SKIN_PART_MAIN',			'主索引檔案');
...
define('_SKIN_PART_MEMBER',		'成員詳細資料');
...
define('_SETTINGS_DEFBLOG',			'預設Blog');
...
define('_SETTINGS_SEECONFIGPHP',		'（查看 config.php）');
define('_SETTINGS_MEDIAURL',			'Media URL （以斜線"/"結束）');
define('_SETTINGS_ALLOWUPLOAD',		'允許檔案上傳？');
define('_SETTINGS_ALLOWUPLOADTYPES','允許上傳檔案的類型');
define('_SETTINGS_CHANGELOGIN',		'允許成員更改登錄密碼');
...
define('_SETTINGS_ALLOWCREATE',		'允許訪客註冊成員賬號');
define('_SETTINGS_NEWLOGIN',			'允許訪客建立的賬號登錄');
define('_SETTINGS_NEWLOGIN2',		'（只在新註冊的賬號上生效）');
define('_SETTINGS_MEMBERMSGS',		'允許成員到成員的服務');
define('_SETTINGS_LANGUAGE',			'缺省語言');
define('_SETTINGS_DISABLESITE',		'關閉站點');
define('_SETTINGS_DBLOGIN',			'MySQL 登錄 &amp; 資料庫');
...
define('_SETTINGS_MEDIAPREFIX',		'前綴上傳檔案帶有日期');
define('_SETTINGS_MEMBERS',			'成員設置');

// bans
define('_BAN_TITLE',				'禁止列表');
define('_BAN_NONE',					'該Blog沒有任何封鎖');
define('_BAN_NEW_TITLE',			'添加新的封鎖');
define('_BAN_NEW_TEXT',				'現在添加一條新的封鎖');
define('_BAN_REMOVE_TITLE',			'刪除規定');
define('_BAN_IPRANGE',				'IP封鎖');
define('_BAN_BLOGS',				'哪個Blog？');
define('_BAN_DELETE_TITLE',			'刪除封鎖');
define('_BAN_ALLBLOGS',				'您擁有管理員權利的所有Blog。');
define('_BAN_REMOVED_TITLE',		'封鎖刪除');
define('_BAN_REMOVED_TEXT',			'從以下Blog中刪除封鎖：');
define('_BAN_ADD_TITLE',			'添加封鎖');
define('_BAN_IPRANGE_TEXT',			'選擇您要封鎖的IP。');
define('_BAN_BLOGS_TEXT',			'您可以選擇僅僅禁止本Blog或者禁止所有您擁有管理員權力的Blog，在下面選擇。');
define('_BAN_REASON_TITLE',			'原因');
define('_BAN_REASON_TEXT',			'您可以為封鎖提供一個原因，當被禁止的IP所有者試圖添加另一條評論或者是投票時顯示，最多128字。');
...
// membermanagement
define('_MEMBERS_TITLE',			'成員管理');
define('_MEMBERS_CURRENT',			'當前成員');
define('_MEMBERS_NEW',				'新成員');
...
define('_MEMBERS_EMAIL_EDIT',		'（當您改變郵件地址的時候，將會向該地址發關一封郵件）');
...
define('_MEMBERS_NEW_BTN',			'添加成員');
define('_MEMBERS_EDIT',				'編輯成員');
define('_MEMBERS_EDIT_BTN',			'改變設置');
define('_MEMBERS_BACKTOOVERVIEW',	'返回成員總攬');
define('_MEMBERS_DEFLANG',			'語言');
define('_MEMBERS_USESITELANG',		'-  使用站點設置 -');

// List of blogs (TT = tooltip)
define('_BLOGLIST_TT_VISIT',		'訪問該站');
define('_BLOGLIST_ADD',				'添加文章');
define('_BLOGLIST_TT_ADD',			'在這個Blog中添加新文章');
...
define('_BLOGLIST_BANS',			'被封禁項目');
define('_BLOGLIST_TT_BANS',			'查看、添加或者移除被禁止的IP');
define('_BLOGLIST_DELETE',			'全部刪除');
define('_BLOGLIST_TT_DELETE',		'刪除該Blog');

// OVERVIEW screen
define('_OVERVIEW_YRBLOGS',			'我的Blog');
define('_OVERVIEW_YRDRAFTS',		'我的草稿');
define('_OVERVIEW_YRSETTINGS',		'我的設置');
define('_OVERVIEW_GSETTINGS',		'普通設置');
define('_OVERVIEW_NOBLOGS',			'您不屬於任何Blog的成員名單');
define('_OVERVIEW_NODRAFTS',		'沒有草稿');
define('_OVERVIEW_EDITSETTINGS',	'編輯您的設置…');
define('_OVERVIEW_BROWSEITEMS',		'瀏覽您的文章…');
define('_OVERVIEW_BROWSECOMM',		'瀏覽您的評論…');
define('_OVERVIEW_VIEWLOG',			'查看動作紀錄…');
define('_OVERVIEW_MEMBERS',			'管理成員…');
define('_OVERVIEW_NEWLOG',			'建立新的Blog…');
...
// ITEMLIST
define('_ITEMLIST_BLOG',			'這個Blog的文章'); 
define('_ITEMLIST_YOUR',			'我的文章');

// Comments
define('_COMMENTS',					'評論');
define('_NOCOMMENTS',				'這篇文章沒有評論');
define('_COMMENTS_YOUR',			'我的評論');
define('_NOCOMMENTS_YOUR',			'您沒有發表任何評論');

// LISTS (general)
define('_LISTS_NOMORE',				'沒有更多結果或者沒有結果');
define('_LISTS_PREV',				'上一頁');
define('_LISTS_NEXT',				'下一頁');
define('_LISTS_SEARCH',				'搜索');
define('_LISTS_CHANGE',				'改變');
define('_LISTS_PERPAGE',			'篇/頁');
...
// teamlist
define('_LIST_TEAM_ADMIN',			'管理員');
define('_LIST_TEAM_CHADMIN',		'更改管理員');
...
define('_EDITC_MEMBER',				'成員');
define('_EDITC_NONMEMBER',			'非成員');

// move item
define('_MOVE_TITLE',				'移動到哪個Blog');
