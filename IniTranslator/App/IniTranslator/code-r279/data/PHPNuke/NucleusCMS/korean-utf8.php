...
//
// TranslateLog:
// v2.5 : Translated by enamu & sicrone
// v3.1x: 노정용(Jungyong Ro, http://www.ibizkorea.com, laotzu@ibizkorea.com)
// v3.2 : 최영봉(Youngbong Choe, http://justhurd.net, hurd@wikix.org)
//
...
define('_LIST_PLUG_SUBS_NEEDUPDATE','\'구독 리스트 갱신\' 버튼을 눌러 플러그인의 구독 리스트를 갱신하세요.');
define('_LIST_PLUGS_DEP',			'플러그인을 설치하려면 다음이 필요합니다:');
...
define('_COMMENTS_BLOG',			'모든 코멘트');
define('_NOCOMMENTS_BLOG',			'이 블로그에는 코멘트가 없습니다');
define('_BLOGLIST_COMMENTS',		'코멘트');
define('_BLOGLIST_TT_COMMENTS',		'이 블로그의 모든 코멘트 목록');


// for use in archivetype-skinvar
define('_ARCHIVETYPE_DAY',			'일');
define('_ARCHIVETYPE_MONTH',		'월');

// tickets (prevents malicious users to trick an admin to perform actions he doesn't want)
define('_ERROR_BADTICKET',			'티켓이 올바르지 않거나 만료되었습니다');

// plugin dependency
define('_ERROR_INSREQPLUGIN',		'플러그인을 설치할 수 없습니다. 다음이 필요합니다: ');
define('_ERROR_DELREQPLUGIN',		'플러그인을 제거할 수 없습니다. 다음 플러그인이 사용하고 있습니다: ');

// cookie prefix
define('_SETTINGS_COOKIEPREFIX',	'쿠키 접두어');
