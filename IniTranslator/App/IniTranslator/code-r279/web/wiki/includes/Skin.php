...
END;
	...
	function getCopyrightIcon() {
       ...
       function getPoweredBy() {
              ...
              $sf  = '<a href="http://sourceforge.net"><img src="http://sourceforge.net/sflogo.php?group_id=78744&type=1" width="88" height="31" border="0" alt="Sourceforge.net Logo" /> </a>';
              $support = '<a href="http://sourceforge.net/donate/index.php?group_id=78744"><img src="http://images.sourceforge.net/images/project-support.jpg" width="88" height="31" border="0" alt="Support this project"  /></a>';
              $img = '<a href="http://www.mediawiki.org/"><img src="'.$url.'" alt="MediaWiki" /></a>'.$sf.$support;
              return $img;
       }
